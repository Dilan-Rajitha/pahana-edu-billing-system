  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .subbar{
      ...
      border-bottom:1px solid var(--border); position:sticky; top:56px; z-index:40;
    }
    ...
    .card-header{display:flex; align-items:center; justify-content:space-between; padding:16px 18px; border-bottom:1px solid var(--border); background:#f8fafc}
    h2{margin:0; font-size:20px}

    /* Form row */
    .form-row{display:flex; gap:10px; align-items:center; flex-wrap:wrap; padding:16px 18px; border-bottom:1px solid var(--border); background:#fff}
    input[type="text"], input[type="password"], select{
      padding:10px 12px; border:1px solid var(--border); border-radius:10px; background:#fff; min-width:200px; outline:none;
    }
    ...
    thead th{position:sticky; top:0; background:#f8fafc; border-bottom:1px solid var(--border); z-index:1}
    ...
    @media (max-width:720px){
      ...
      tbody tr{background:#fff; border:1px solid var(--border); margin:10px 0; border-radius:12px}
