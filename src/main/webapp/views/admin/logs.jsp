  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn{
      ...
      text-decoration:none; color:var(--text); font-weight:800; display:inline-flex; align-items:center; gap:6px;
      transition:.15s;
    }
    ...
    .filters input,.filters select{padding:10px 12px; border:1px solid var(--border); border-radius:10px; background:#fff; min-width:180px}
    ...
    thead th{
      position:sticky; top:0; background:#f8fafc; border-bottom:1px solid var(--border); z-index:1;
      text-align:center; padding:12px; font-weight:800;
    }
